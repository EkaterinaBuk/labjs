...
{ 
    ...
    // вычисление скалярного произведения последовательно с помощью функции inner_product  
    ...
    //  вывод, значение где поточное эффективнее быстрее время меньше размерность (лонг лонг), вводить кол-во потоков 
    return 0; 
}
